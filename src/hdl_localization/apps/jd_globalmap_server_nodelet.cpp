...
class jd_GlobalmapServerNodelet : public nodelet::Nodelet {
public:
  using PointT = pcl::PointXYZ;

  jd_GlobalmapServerNodelet() {
  }
  virtual ~jd_GlobalmapServerNodelet() {
  }
  ...
  void onInit() override {
    ...
    globalmap_pub = nh.advertise<sensor_msgs::PointCloud2>("/jdd_globalmap", 5, true);
...
PLUGINLIB_EXPORT_CLASS(hdl_localization::jd_GlobalmapServerNodelet, nodelet::Nodelet)
